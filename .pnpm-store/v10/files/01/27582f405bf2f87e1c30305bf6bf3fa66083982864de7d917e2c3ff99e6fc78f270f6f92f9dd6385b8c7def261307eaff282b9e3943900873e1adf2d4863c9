...
const ForwardThoughtChain = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  ...
  const mergedCls = (0, _clsx.clsx)(className, prefixCls, contextConfig.className, contextConfig.classNames.root, rootClassName, hashId, cssVarCls, classNames.root, `${prefixCls}-box`, {
