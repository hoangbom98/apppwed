...
const APP_CATALOG_SEED = [
  { appId: 'game',   name: 'GAMEX',      developer: 'GAMEX Entertainment',        category: 'Giải trí · 18+',        iconUrl: '/icons/icon-192.png',  primaryColor: '#194C38', rating: 4.6, reviewsCount: '12.5 N', downloads: '500 N+', androidLink: 'https://yourdomain.com/downloads/gamex.apk',       iosLink: 'itms-services://?action=download-manifest&url=https://yourdomain.com/ios/gamex.plist',       description: 'Hệ thống giải trí trực tuyến hàng đầu Việt Nam.', features: ['🎰 Slots 1000+ game','🃏 Casino trực tiếp','⚽ Cá cược thể thao','💳 Nạp/Rút tức thì'], isPublished: true, sortOrder: 1 },
  { appId: 'dating', name: 'AppLive18',  developer: 'AppLive18 Entertainment',    category: 'Hẹn hò · Social',       iconUrl: '/icons/app-icon.svg',  primaryColor: '#ec4899', rating: 4.5, reviewsCount: '23 N',   downloads: '1 Tr+',  androidLink: 'https://yourdomain.com/downloads/applive18.apk',   iosLink: 'itms-services://?action=download-manifest&url=https://yourdomain.com/ios/applive18-manifest.plist', description: 'Nền tảng hẹn hò và livestream hàng đầu Việt Nam.', features: ['💘 Swipe & Kết đôi','📺 Live Stream','💬 Chat & Video Call','👑 VIP'], isPublished: true, sortOrder: 2 },
  { appId: 'sports', name: 'Sports Live',developer: 'Sports Live Entertainment',  category: 'Thể thao · Tin tức',    iconUrl: '/icons/app-icon.svg',  primaryColor: '#16a34a', rating: 4.7, reviewsCount: '8.2 N',  downloads: '200 N+', androidLink: 'https://yourdomain.com/downloads/sports.apk',      iosLink: 'itms-services://?action=download-manifest&url=https://yourdomain.com/ios/sports-manifest.plist',   description: 'Xem bóng đá trực tiếp, tỷ số & livestream HD.',   features: ['⚽ Tỷ số trực tiếp 24/7','📺 Livestream HD','🏆 400+ giải đấu','🔔 Thông báo bàn thắng'], isPublished: true, sortOrder: 3 },
  { appId: 'trade',  name: 'Trade Pro',  developer: 'Trade Pro Exchange',         category: 'Tài chính · Đầu tư',    iconUrl: '/icons/app-icon.svg',  primaryColor: '#3b82f6', rating: 4.4, reviewsCount: '5.6 N',  downloads: '100 N+', androidLink: 'https://yourdomain.com/downloads/tradepro.apk',    iosLink: 'itms-services://?action=download-manifest&url=https://yourdomain.com/ios/tradepro-manifest.plist',  description: 'Giao dịch chứng khoán & Crypto chuyên nghiệp.',   features: ['📈 Biểu đồ realtime','🔔 Cảnh báo giá','💼 Quản lý danh mục','🔒 Bảo mật 2FA'], isPublished: true, sortOrder: 4 },
];
