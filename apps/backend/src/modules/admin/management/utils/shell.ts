...
/** Workspace root (3 levels above code/backend/scripts/dist/) */
...
/** code/backend/scripts/ dir */
export const SCRIPTS_DIR     = path.join(SOURCE_DIR, 'scripts');

/**
 * Run a bash script from code/backend/scripts/, streaming stdout/stderr to the
 ...
 *
 * @param scriptName  File name inside code/backend/scripts/ (e.g. "deploy.sh")
