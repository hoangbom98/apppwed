...
exports.createOrder = async (req, res) => {
  try {
    ...
    // Block trading-frozen users (isjy equivalent)
    ...
    // Run order matching asynchronously (fire-and-forget, non-blocking)
    const matcher = new OrderMatchingService(req.prisma, req.io || null);
