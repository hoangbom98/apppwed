  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--bank-bg)' }}>
      ...
      <div className="px-6 pt-14 pb-8 text-center" style={{ background: 'var(--bank-primary)' }}>
        ...
        <p className="text-white/80 text-sm mt-1">Ngân hàng số thế hệ mới</p>
      </div>
      ...
      <div className="flex-1 px-6 pt-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              style={{ background: '#fff', border: '1px solid var(--bank-border)', color: 'var(--bank-text)' }}
            />
          </div>
          <div>
        ...
        <p className="text-center text-sm mt-6" style={{ color: 'var(--bank-muted)' }}>
          Chưa có tài khoản?{' '}
          <Link to="/register" className="font-semibold" style={{ color: 'var(--bank-primary)' }}>Đăng ký ngay</Link>
        </p>
      </div>
    </div>
  );
