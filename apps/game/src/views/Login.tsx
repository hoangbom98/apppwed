    ...
    <div className="min-h-screen bg-dark flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Đăng nhập tài khoản</p>
        </div>

        <form onSubmit={handleSubmit(onSubmit)} className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-4">
          {/* Email */}
          <div>
