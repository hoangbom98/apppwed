...
const TRADE_APP: Record<string, any> = {
  ...
  // ── Download links ───────────────────────────────────────────────────
  androidLink: 'https://tc-gaming.live/downloads/tradepro.apk',
  iosLink:     'itms-services://?action=download-manifest&url=https://tc-gaming.live/ios/tradepro-manifest.plist',
  qrCodeUrl:   '',
