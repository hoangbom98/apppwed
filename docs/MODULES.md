...
**Frontend:** `apps/hub/` · Port 5173 · Capacitor mobile support  
**Backend routes:** `apps/backend/src/modules/hub/routes/index.js`  
...
**Frontend:** `apps/game/` · Port 5174 · Capacitor mobile support  
**Backend routes:** `apps/backend/src/modules/game/routes/index.js`  
...
**Backend routes:** `apps/backend/src/modules/lkvip/routes/`  
...
**Frontend:** `apps/trading/` · Port 5177  
**Backend routes:** `apps/backend/src/modules/trade/routes/index.js`  
...
**Frontend:** `apps/dating/` · Port 5176 · Capacitor + WebRTC  
**Backend routes:** `apps/backend/src/modules/dating/routes/index.js`  
...
**Frontend:** `apps/sports/` · Port 5178  
**Backend routes:** `apps/backend/src/modules/sports/routes/index.js`  
...
**Frontend:** `apps/admin-dashboard/` · Port 5180 (JSX, no TypeScript)  
**Backend routes:** `apps/backend/src/modules/admin/routes/index.js`  
...
Located in `apps/backend/src/shared/`.
