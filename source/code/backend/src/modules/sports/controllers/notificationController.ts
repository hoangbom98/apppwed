'use strict';
/**
 * sports/controllers/notificationController.js
...
exports.markRead = async (req, res) => {
  try {
    ...
    // IDOR guard: ensure notification belongs to the requesting user
...
// Alias for backward-compat with sports routes (uses .list)
exports.list = exports.getNotifications;
