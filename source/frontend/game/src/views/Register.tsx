...
const schema = yup.object({
  username:     yup.string().min(3, 'Ít nhất 3 ký tự').max(30).required('Vui lòng nhập tên đăng nhập'),
    ...
    <div className="min-h-screen bg-dark flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          <div className="w-16 h-16 rounded-2xl bg-accent flex items-center justify-center text-3xl font-black text-dark mx-auto mb-3">
            G
          </div>
          <h1 className="text-2xl font-black text-white">GAMEX</h1>
          <p className="text-gray-400 text-sm mt-1">Tạo tài khoản mới</p>
        </div>

        <form onSubmit={handleSubmit(onSubmit)} className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-3">
