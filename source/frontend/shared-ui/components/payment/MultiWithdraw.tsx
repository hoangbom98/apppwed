...
const CHANNELS: ChannelConfig[] = [
  ...
  { code: 'alipay', label: 'Alipay',    icon: '💙',  color: 'text-blue-600'   },
  { code: 'wechat', label: 'WeChat Pay',icon: '💚',  color: 'text-green-500'  },
  { code: 'bank',   label: 'Ngân hàng', icon: '🏦',  color: 'text-gray-700'   },
];
