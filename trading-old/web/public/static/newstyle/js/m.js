...
//自动高度
function autoHeight() {
    // var headerbarH = $(".header").height();
    var headerH = $(".header").height();
    var NavH = $(".infobox").height();
    var timesH = $(".times").height();
    var tipsH = $(".tips").height();
    var btnsH = $(".btns").height();
    var WinHss = $(window).height();
    console.log(WinHss,headerH,NavH,timesH,tipsH ,btnsH);
    // $("footer").height(WinHss - headerbarH - headerH - NavH - tradebarH - ecBarH);
    $("#ecKx").height(WinHss/2);
}
...
function getMaindata(ctype) {
    ...
    Vtype = $(".trade-chart-period.active").attr('data');
...
function gotoecharts(data) {
    ...
    $("#tips1 .a").text(getDateHM(data.topdata.topdata) + ":00");
    $("#tips1 .b").text(data.topdata.now);
    $("#tips1 .c").text(data.topdata.open);
    $("#tips1 .d").text(data.topdata.lowest);
    $("#tips1 .e").text(data.topdata.highest);
    ...
    deaL = dea.length - 1;
    macdL = macd.length - 1;
    $("#tips2 .a").text(diff[diffL].toFixed(4));
    $("#tips2 .b").text(dea[deaL].toFixed(4));
    $("#tips2 .c").text(macd[macdL].toFixed(4));
